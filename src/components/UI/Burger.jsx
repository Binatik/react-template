...
import { BurgerLine } from "@src/store/styled/components/other";
...
const Line6 = styled(BurgerLine)`
  transform: ${props =>
    props.isAciveBurger ? "translateX(-18px) translateY(3px) rotate(-45deg) scale(0.7)" : "none"};
`;
...
const Line4 = styled(BurgerLine)`
  transform: ${props =>
    props.isAciveBurger ? "translateY(0px) rotate(-45deg) scale(0.7)" : "none"};
`;
